...
function BuyerShop() {
    ...
    const getatlocation = async () => {
        const response = await fetch(`${server_url}/api/farmeritem/getatlocation`, {
            method: "POST",
            headers: {
    ...
    const getotherlocation = async () => {
        const response = await fetch(`${server_url}/api/farmeritem/getotherlocation`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    const handleSearch = async (e) => {
        ...
        const response = await fetch(`${server_url}/api/farmeritem/getbyname`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
