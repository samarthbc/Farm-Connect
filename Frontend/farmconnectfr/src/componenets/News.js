...
function News() {
    ...
    const updateNews = async () => {
        const url = `https://newsapi.org/v2/everything?q=agriculture&apiKey=a7742701b0824034b7519ea4cd424fe8&page=1&pageSize=100`
    ...
    const updateIndNews = async () => {
        const url = "https://newsapi.org/v2/top-headlines?q=agriculture&country=in&apiKey=a7742701b0824034b7519ea4cd424fe8"
    ...
    return (
        <>
            <h3 className="text-danger text-center mt-3 nb-check" style={{ fontFamily: "'Caveat', cursive", fontWeight: "bolder", fontSize: "40px" }}>Top Agriculture Headlines in India</h3>
            ...
            <h3 className='text-danger text-center mt-3' style={{ fontFamily: "'Caveat', cursive", fontWeight: "bolder", fontSize: "40px" }}>Agriculture News Across the Globe <i class="fa-solid fa-globe"></i></h3>
